...
try {
		Debug.PushSubsStack("Append (b4xbytesbuilder) ","b4xbytesbuilder",6,__ref.getField(false, "bi"),__ref,24);
...
try {
		Debug.PushSubsStack("Append2 (b4xbytesbuilder) ","b4xbytesbuilder",6,__ref.getField(false, "bi"),__ref,33);
...
try {
		Debug.PushSubsStack("ChangeLength (b4xbytesbuilder) ","b4xbytesbuilder",6,__ref.getField(false, "bi"),__ref,12);
...
try {
		Debug.PushSubsStack("Clear (b4xbytesbuilder) ","b4xbytesbuilder",6,__ref.getField(false, "bi"),__ref,39);
...
try {
		Debug.PushSubsStack("getInternalBuffer (b4xbytesbuilder) ","b4xbytesbuilder",6,__ref.getField(false, "bi"),__ref,104);
...
try {
		Debug.PushSubsStack("getLength (b4xbytesbuilder) ","b4xbytesbuilder",6,__ref.getField(false, "bi"),__ref,94);
...
try {
		Debug.PushSubsStack("IndexOf (b4xbytesbuilder) ","b4xbytesbuilder",6,__ref.getField(false, "bi"),__ref,109);
...
try {
		Debug.PushSubsStack("IndexOf2 (b4xbytesbuilder) ","b4xbytesbuilder",6,__ref.getField(false, "bi"),__ref,114);
...
try {
		Debug.PushSubsStack("Initialize (b4xbytesbuilder) ","b4xbytesbuilder",6,__ref.getField(false, "bi"),__ref,6);
...
try {
		Debug.PushSubsStack("Insert (b4xbytesbuilder) ","b4xbytesbuilder",6,__ref.getField(false, "bi"),__ref,45);
...
b4i_main.__c.runVoidMethod ("LogImpl:::","92228226",RemoteObject.createImmutable("Index too large"),0);};
...
try {
		Debug.PushSubsStack("Remove (b4xbytesbuilder) ","b4xbytesbuilder",6,__ref.getField(false, "bi"),__ref,71);
...
try {
		Debug.PushSubsStack("Set (b4xbytesbuilder) ","b4xbytesbuilder",6,__ref.getField(false, "bi"),__ref,58);
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(">",_index,BA.numberCast(double.class, __ref.getField(true,"_mlength" /*RemoteObject*/ )))) { 
b4i_main.__c.runVoidMethod ("LogImpl:::","92293762",RemoteObject.createImmutable("Index too large"),0);};
...
try {
		Debug.PushSubsStack("SubArray (b4xbytesbuilder) ","b4xbytesbuilder",6,__ref.getField(false, "bi"),__ref,82);
...
try {
		Debug.PushSubsStack("SubArray2 (b4xbytesbuilder) ","b4xbytesbuilder",6,__ref.getField(false, "bi"),__ref,88);
...
try {
		Debug.PushSubsStack("ToArray (b4xbytesbuilder) ","b4xbytesbuilder",6,__ref.getField(false, "bi"),__ref,99);
